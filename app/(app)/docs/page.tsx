...
export default function DocsPage() {
  ...
  const docs: { category: string; items: DocItem[] }[] = [
    ...
    },
    {
      category: '業務マニュアル',
      items: [
        { title: '奥寺さん向けマニュアル', desc: '出面入力・月次集計・給与計算・休暇管理（有給・帰国）・帳票出力', url: '/manual-okudera.html', icon: '📘', updated: '2026-04-18' },
        ...
        { title: '休暇管理マニュアル', desc: '有給管理・帰国情報・時季指定・期末買取・時効処理・管理簿出力など休暇管理全機能', url: '/manual-yukyu.html', icon: '📙', updated: '2026-04-26' },
